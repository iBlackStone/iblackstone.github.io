...
- **Accueil** : affiche le projet actuel et la prochaine action, puis classe les projets par états — préparation, en cours, terminé ou abandonné.
  Lorsque Ravelry est connecté, l’en-tête peut afficher de grandes recommandations de modèles gratuits selon les projets enregistrés sur cet appareil. Balayez ou attendez le défilement automatique, puis touchez un modèle pour choisir entre l’aperçu, les détails Ravelry ou le téléchargement et l’importation. La carte du projet actuel reste affichée sans connexion, en cas d’indisponibilité ou sans recommandation adaptée.
