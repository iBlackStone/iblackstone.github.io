...
ホームでは最近更新した作品が優先表示されます。作品カードは 1:1 の正方形カバーを使用し、タイトルを画像下端に重ね、状態・メインカウンター・進捗を画像の下に表示します。ライト／ダーク表示と iPad の縦横切り替えにも追従します。作品を開くと、メインカウンター、材料、チャート、ノート、技法へ移動できます。状態変更は一覧整理のためのもので、内容は削除しません。
