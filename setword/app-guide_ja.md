...
- **ホーム**：現在のプロジェクトと次の操作を表示し、準備中、進行中、完了、放棄などの状態別に整理します。
  Ravelry 接続中は、この端末の作品傾向に基づく無料パターンの大きな画像が上部に表示されることがあります。左右にスワイプするか自動切替を待ち、タップすると大きな画像のプレビュー、Ravelry 詳細、ダウンロードして読込を選べます。未接続、通信不可、候補なしの場合は従来の現在の作品カードに戻ります。
